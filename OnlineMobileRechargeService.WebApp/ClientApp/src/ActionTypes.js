...
export const PREPAID_SELECT_PLAN = 'PREPAID_SELECT_PLAN';

export const SUBMIT_PREPAID_ORDER = 'SUBMIT_PREPAID_ORDER';
export const SUBMIT_PREPAID_ORDER_SUCCESS = 'SUBMIT_PREPAID_ORDER_SUCCESS';
export const SUBMIT_PREPAID_ORDER_FAILED = 'SUBMIT_PREPAID_ORDER_FAILED';
